...
Gem::Specification.new do |s|
  ...
  s.files = ["Gemfile", "README.markdown", "Rakefile", "VERSION", "bin/dashboard", "dashboard-client.gemspec", "dashboardrc.sample", "lib/dashboard-client.rb", "lib/dashboard.rb", "lib/dashboard/client.rb", "lib/dashboard/config.rb", "lib/dashboard/plugin.rb", "lib/dashboard/plugins.rb", "lib/dashboard/plugins/clock.rb", "lib/dashboard/plugins/code_coverage.rb", "lib/dashboard/plugins/cpu_usage.rb", "lib/dashboard/plugins/disk_usage.rb", "lib/dashboard/plugins/hudson.rb", "lib/dashboard/plugins/load_averages.rb", "lib/dashboard/plugins/pkwde_live_data.rb", "lib/dashboard/plugins/yahoo_weather.rb", "lib/dashboard/report.rb", "lib/dashboard/version.rb", "lib/dashboard/xt/numeric.rb", "test/dashboard/config_test.rb", "test/dashboard/plugins/disk_usage_test.rb", "test/dashboard/plugins/hudson_test.rb", "test/dashboard/plugins/load_averages_test.rb"]
